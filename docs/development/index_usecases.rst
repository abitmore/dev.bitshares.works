...
If you have not read `BitShares Documentation for all users <http://docs.bitshares.eu/en/latest>`_ (http://docs.bitshares.eu/en/latest), we recommend you to read through as your basic knowledge of BitShares.
...
* `What is different BitShares <http://docs.bitshares.eu/en/latest/technology/difference_bitshares.html>`_ (http://docs.bitshares.eu/en/latest)
